// lk
import CoinBrain from "../assets/images/coinbrain.png";
import CoinRanking from "../assets/images/coinranking.png";
import BSnScan from "../assets/images/bsnscan.svg";
import Okx from "../assets/images/okx.jpeg";
// Section1
...
import HorseImage from "../assets/images/section1/main-bg-3.svg";
...
import GroupCatsImage from "../assets/images/section8/cats.png";
...
export const section1Content = {
  ...
  HorseImage,
  ShootingStarImage,
  title: "Welcome To BBCat",
  subtitle: "BBCAT is a lovely kitty that is here to stay and grow join baby cat as it goes to the moon",
};

export const section2Content = {
  title: '0xcb3e4688c4cd90022f74f5c70a775172ecab4d52',
  items: [
...
export const section3Link = {
  title1: "Optimize your trades across hundreds of DEXes on multiple networks",
  LIST: [
...
export const section4Content = {
  top: {
    title: "About the protect",
    subtitle1:
      "BBCAT is a rapidly growing community with an ambition to infiltrate every household and provide you with X.",
      subtitle2:
      "BBCAT always strives to become the most beloved and successful project by adhering to all market standards and surpassing all indicators.",
      subtitle3:
      "Unlike fraudulent projects that have eroded people's trust in the market, BBCAT aims to restore this trust and ensure the safety of investors.",
    image: NewsImg,
  },
  bottom: {
    title: "BBCat Wallet",
    TABS: [
      ...
      },
      {
        ...
        image: Phone2Img,
        subtitle:
          "Stake BBCat to participate in network governance and be eligible for gas costs refunds.",
      },
    ],
  },
};
...
export const section5Content = {
  ...
  title: "BBCat Fusion",
  subtitle:
    "The Fusion upgrade makes swaps on BBCat yet more efficient and secure, combining liquidity from the entire crypto market in one place.",
};

export const section6Content = {
  title: "We’ve built a Community that is here to grow",
  ITEMS: [
    {
      title: "Decentralized Platform",
      subtitle:
        "BBCat lives on the binance blockcahin",
      image: Sec6Image1,
    },
    {
     title: "Community Driven",
     subtitle:
       "BBCat is going to the moon",
      image: Sec6Image2,
    },
    {
...
export const section7Content = {
  ...
  ITEMS: [
    ...
    {
      title: "BBCat grant program",
      subtitle:
        "An initiative that fosters the BBCat Network's growth and incentivizes contributions through grants and other resources.",
      image: Sec7Image2,
    },
  ],
};
...
export const section8Content = {
  title: "Join Our BBCat Community",
  subtitle:
    "Come fly with us to the moon",
  caption:
    "Come fly with us to the moon.",
  GroupCatsImage,
  Socials: [
  ...
  ITEMS: [
    {
      title: "BBCat DAO",
      subtitle:
        "A governance tool that enables BBCat stakers to vote for key protocol parameters.",
      image: Sec9Image1,
    },
    {
      title: "BBCat token",
      subtitle:
        "A token that facilitates BBCat protocol governance and participation in the network's evolution.",
      image: Sec9Image2,
    },
  ]
};
...
export const footerContent = {
  ...
  subscribe: {
    title: "Subscribe to BBCat newsletter",
  ...
  copyright: {
    ...
    right: "Contact Email:info@catcoin.today",
  },
};
